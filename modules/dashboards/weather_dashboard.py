...
def generate_weather_dashboard(api_endpoint: str, screen_size=(640, 400)):
    ...
    forecast = get_weather_forecast(api_endpoint)
    ...
    img = Image.new('RGB', screen_size, color='black')
